...
//  МассивСтрокиТаблицы1, МассивСтрокиТаблицы2 - массивы, в которых хранится разница первой таблицы относительно второй и второй таблицы относительно первой (строки, которые изменились, будут в обеих массивах)
//  
//
Процедура НайтиОтличияТаблиц(Таблица1, Таблица2, МассивСтрокиТаблицы1, МассивСтрокиТаблицы2, СтрокаПереченьКолонок = "", СтрокаИсключемыеКолонки = "", УчитыватьПорядок = Ложь)
