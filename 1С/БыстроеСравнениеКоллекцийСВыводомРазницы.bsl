// Сделал быструю процедуру сравнения коллекций, за основу брал найденный на просторах код, но доработал довольно сильно
// За секунд 10-15 получается дельта двух ТЗ, в которых почти 400 тысяч строк
