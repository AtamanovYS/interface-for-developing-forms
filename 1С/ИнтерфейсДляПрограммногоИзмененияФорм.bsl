...
//
Функция ДобавитьРеквизит(Форма, СвойстваРеквизита, Значение = Неопределено)
...
//   * ПолеФормы - созданное поле
//
Функция ДобавитьРеквизитИПоле(Форма, СвойстваРеквизита, Значение = Неопределено, Родитель = Неопределено, ЭлементПередКоторымВставить = Неопределено, ВидПоля = Неопределено, Эталон = Неопределено)

	Реквизит = ДобавитьРеквизит(Форма, СвойстваРеквизита, Значение);
...
//   * КнопкаФормы - созданная кнопка
//
Функция ДобавитьКомандуИКнопку(Форма, Имя, Действие = "Подключаемый_ВыполнитьПереопределяемуюКоманду", Родитель = Неопределено, ЭлементПередКоторымВставить = Неопределено, ВидКоманды = Неопределено, Эталон = Неопределено)
