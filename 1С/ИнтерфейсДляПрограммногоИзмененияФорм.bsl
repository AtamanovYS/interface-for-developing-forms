// Подробно описал в статье, как с этим работать и почему это удобно: https://infostart.ru/1c/articles/1556681
...
Функция ПолучитьЗаголовокПоИмени(Имя, РазделительПрефиксаОтИмени = "_", КонкретныйПрефикс = "")
	...
	Возврат Врег(Лев(Заголовок, 1)) + Сред(Нрег(Заголовок), 2);
